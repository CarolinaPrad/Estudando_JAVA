public class EstudoOperadores {
    public static void main(String[] args) {
        ...
        // Fzendo a divisão da forma correta
        int c  = 10;
        double d = 15.0;
        double divisao2 = d / c;
        // divisão entre double e int => double
        System.out.println("Dividão entre double: " + divisao2);

        //Math
        double x = Math.pow(2, 3); // potencia 2 elevado a 3
        double Y = Math.sqrt(144); // raiz quadrada de 144
